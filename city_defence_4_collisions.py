...
enemy_images = []
enemy_list = [
    r"E:\City_Defence-A-Python-Shooting-Game-Built-with-Pygame\image\image\virus_red.png",
    r"E:\City_Defence-A-Python-Shooting-Game-Built-with-Pygame\image\image\virus_blue.png",
    r"E:\City_Defence-A-Python-Shooting-Game-Built-with-Pygame\image\image\virus_violet.png"
]
...
def draw_text(surface, text, size, x, y):
    """Function to draw score text on the screen."""
...
# Initialize sprite groups and objects
...
while running:
    ...
    # Check for laser-enemy collision
    ...
    for hit in hits:
        add_enemy()
        player.hide()
        score -= 5  # Deduct score when player gets hit (optional)
